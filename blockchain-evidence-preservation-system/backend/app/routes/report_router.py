...
async def submit_report(
    ...
    report = AnalysisReport(
        ...
        # TDFL-STD-2023 mandatory fields
        analyst_certification_number=report_data.analyst_certification_number,
        forensic_tool_name=report_data.forensic_tool_name,
        forensic_tool_version=report_data.forensic_tool_version,
        lab_reference_number=report_data.lab_reference_number,
        examination_start_date=report_data.examination_start_date,
        examination_end_date=report_data.examination_end_date,
        work_copy_hash=report_data.work_copy_hash,
        independence_statement=report_data.independence_statement or False,
        independence_statement_text=report_data.independence_statement_text,
        copies_made=report_data.copies_made,
        copies_location=report_data.copies_location,
        is_expert_witness=report_data.is_expert_witness or False,
        expert_witness_court_designation=report_data.expert_witness_court_designation,
        analyst_declaration=report_data.analyst_declaration,
        status="submitted",
