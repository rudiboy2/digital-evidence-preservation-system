...
var ComputedRefImpl = class {
	...
	get value() {
		...
		if (self.effect._dirtyLevel >= 2) {
			if (this._warnRecursive) warn$2(COMPUTED_SIDE_EFFECT_WARN, `
...
function renderSlot(slots, name, props = {}, fallback, noSlotted) {
	...
	const rendered = createBlock(Fragment, { key: (props.key || validSlotContent && validSlotContent.key || `_${name}`) + (!validSlotContent && fallback ? "_fb" : "") }, validSlotContent || (fallback ? fallback() : []), validSlotContent && slots._ === 1 ? 64 : -2);
	...
	if (setup) {
		...
		if (isPromise(setupResult)) {
			...
			if (isSSR) return setupResult.then((resolvedResult) => {
				...
				if (!instance.suspense) warn$1(`Component <${(_a = Component.name) != null ? _a : "Anonymous"}>: setup function returned a promise, but no <Suspense> boundary was found in the parent component tree. A component with async setup() must be nested in a <Suspense> in order to be rendered.`);
			}
...
//#endregion
export { defineEmits as $, useAttrs as $t, Static as A, onScopeDispose as An, onServerPrefetch as At, createBaseVNode as B, toRef as Bn, renderSlot as Bt, BaseTransitionPropsValidators as C, getCurrentScope as Cn, onBeforeUnmount as Ct, ErrorTypeStrings as D, isRef as Dn, onMounted as Dt, ErrorCodes as E, isReadonly as En, onErrorCaptured as Et, callWithAsyncErrorHandling as F, shallowReactive as Fn, provide as Ft, createPropsRestProxy as G, camelize as Gn, resolveTransitionHooks as Gt, createCommentVNode as H, toValue as Hn, resolveDirective as Ht, callWithErrorHandling as I, shallowReadonly as In, pushScopeId as It, createStaticVNode as J, normalizeProps as Jn, setTransitionHooks as Jt, createRenderer as K, capitalize as Kn, setBlockTracking as Kt, cloneVNode as L, shallowRef as Ln, queuePostFlushCb as Lt, Teleport as M, reactive as Mn, onUpdated as Mt, Text as N, readonly as Nn, openBlock as Nt, Fragment as O, isShallow as On, onRenderTracked as Ot, assertNumber as P, ref as Pn, popScopeId as Pt, defineComponent as Q, transformVNodeArgs as Qt, compatUtils as R, stop as Rn, registerRuntimeCompiler as Rt, BaseTransition as S, effectScope as Sn, onBeforeMount as St, DeprecationTypes as T, isReactive as Tn, onDeactivated as Tt, createElementBlock as U, triggerRef as Un, resolveDynamicComponent as Ut, createBlock as V, toRefs as Vn, resolveComponent as Vt, createHydrationRenderer as W, unref as Wn, resolveFilter as Wt, createVNode as X, toDisplayString as Xn, ssrUtils as Xt, createTextVNode as Y, normalizeStyle as Yn, ssrContextKey as Yt, defineAsyncComponent as Z, toHandlerKey as Zn, toHandlers as Zt, vModelSelect as _, ReactiveEffect as _n, mergeDefaults as _t, createApp as a, warn as an, devtools as at, withKeys as b, customRef as bn, nextTick as bt, defineSSRCustomElement as c, watchPostEffect as cn, guardReactiveProps as ct, render as d, withCtx as dn, hasInjectionContext as dt, useModel as en, defineExpose as et, useCssModule as f, withDefaults as fn, initCustomFormatter as ft, vModelRadio as g, EffectScope as gn, isVNode as gt, vModelDynamic as h, withScopeId as hn, isRuntimeOnly as ht, VueElement as i, version as in, defineSlots as it, Suspense as j, proxyRefs as jn, onUnmounted as jt, KeepAlive as k, markRaw as kn, onRenderTriggered as kt, hydrate as l, watchSyncEffect as ln, h as lt, vModelCheckbox as m, withMemo as mn, isMemoSame as mt, Transition as n, useSlots as nn, defineOptions as nt, createSSRApp as o, watch as on, getCurrentInstance as ot, useCssVars as p, withDirectives as pn, inject as pt, createSlots as q, normalizeClass as qn, setDevtoolsHook as qt, TransitionGroup as r, useTransitionState as rn, defineProps as rt, defineCustomElement as s, watchEffect as sn, getTransitionRawChildren as st, compile as t, useSSRContext as tn, defineModel as tt, initDirectivesForSSR as u, withAsyncContext as un, handleError as ut, vModelText as v, TrackOpTypes as vn, mergeModels as vt, Comment as w, isProxy as wn, onBeforeUpdate as wt, withModifiers as x, effect as xn, onActivated as xt, vShow as y, TriggerOpTypes as yn, mergeProps as yt, computed as z, toRaw as zn, renderList as zt };

//# sourceMappingURL=vue.runtime.esm-bundler-Bkn8KrrI.js.map